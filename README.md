...
- Un navigateur moderne (Chrome, Firefox, Edge, Safari) avec support WebGL
...
1. Cloner ou télécharger le projet :
   ...
   ```bash
   git clone https://github.com/VOTRE-COMPTE/dice-forge.git
   ```

2. Ouvrir `index.html` dans un navigateur.

   > **Note :** Les navigateurs bloquent la lecture audio automatique. Cliquez une fois dans la page avant de lancer un dé si le son ne se déclenche pas.
...
1. Créer un dépôt GitHub (ex. `dice-forge`).
2. Ajouter tous les fichiers (`index.html`, `supabase-config.js`, `audio/`, `README.md`).
...
```text
https://VOTRE-COMPTE.github.io/dice-forge/
```

### Autres hébergeurs statiques

Dice Forge étant une application purement statique, elle fonctionne sur tout hébergeur de fichiers statiques : Netlify, Vercel, Cloudflare Pages, etc. Il suffit de servir le dossier racine.
...
| Le site fonctionne en local mais pas en ligne | Vérifiez que les chemins sont relatifs (pas de `D:/`, `C:/` ou `file:///`) |
| GitHub Pages affiche une page blanche | Assurez-vous que le fichier principal s'appelle `index.html` |
