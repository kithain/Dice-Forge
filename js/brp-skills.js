...
export const BRP_SKILLS = [
  ['Estimation', '15 %', 'Pratique & divers'], ['Art', '05 %', 'Pratique & divers'], ['Artillerie', "Selon la spécialité d'arme", 'Combat'],
  ['Marchandage', '05 %', 'Social & mental'], ['Bagarre', '25 %', 'Combat'], ['Escalade', '40 %', 'Physique'], ['Commandement', '05 %', 'Social & mental'],
  ['Artisanat', '05 %', 'Pratique & divers'], ['Démolition', '01 %', 'Pratique & divers'], ['Déguisement', '01 %', 'Social & mental'], ['Défense', 'DEX×2', 'Combat'],
  ['Conduite', '20 % ou 01 %', 'Physique'], ['Arme à énergie (divers)', "Selon la spécialité d'arme", 'Combat'],
  ...
  ['Médecine', '05 %', 'Connaissances'], ['Arme de mêlée', "Selon la spécialité d'arme", 'Combat'],
  ['Arme de jet', "Selon la spécialité d'arme", 'Combat'], ['Navigation', '10 %', 'Pratique & divers'],
